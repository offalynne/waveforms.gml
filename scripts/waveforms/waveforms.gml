...
function __waveform()
{
    ...
    __triangle = function(_p, _f) { return (-2.0 / _f) * (_p - _f / 2.0 * floor((2.0 * _p)/ _f + 0.5)) * power(-1.0, floor((2.0 * _p)/ _f + 0.5)); }    
    __sawtooth = function(_p, _f) { return -(_p / _f - floor(0.5 + _p / _f)); };    
    __square   = function(_p, _f) { return ((_p mod _f) < (_f / 2))? -0.5 : 0.5; };
    __sine     = function(_p, _f) { return sin(_p * global.__2pi / _f) / -2.0; };
